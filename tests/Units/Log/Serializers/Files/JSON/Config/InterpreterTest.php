...
namespace Valvoid\Fusion\Tests\Units\Log\Serializers\Files\JSON\Config;
...
use Valvoid\Fusion\Log\Serializers\Files\JSON\Config\Interpreter;
...
class InterpreterTest extends Wrapper
{
    public function testDefaultSerializer(): void
    {
        ...
        $interpreter->interpret([], JSON::class);
    }
    ...
    public function testConfiguredSerializer(): void
    {
        ...
        $interpreter->interpret([], ["serializer" => JSON::class]);
    }
    ...
    public function testFilename(): void
    {
        ...
        $interpreter->interpret([], ["filename" => "Y.m.d"]);
    }
    ...
    public function testFilenameException(): void
    {
        ...
        $interpreter->interpret(["#1"], ["filename" => "###"]);
    }
