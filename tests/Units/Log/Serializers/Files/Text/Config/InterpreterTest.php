...
namespace Valvoid\Fusion\Tests\Units\Log\Serializers\Files\Text\Config;
...
use Valvoid\Fusion\Log\Serializers\Files\Text\Config\Interpreter;
...
class InterpreterTest extends Wrapper
{
    public function testDefaultSerializer(): void
    {
        ...
        $interpreter->interpret([], Text::class);
    }
    ...
    public function testConfiguredSerializer(): void
    {
        ...
        $interpreter->interpret([], ["serializer" => Text::class]);
    }
