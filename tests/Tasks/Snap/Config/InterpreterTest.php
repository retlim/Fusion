...
namespace Valvoid\Fusion\Tests\Tasks\Snap\Config;

use Valvoid\Fusion\Bus\Bus;
use Valvoid\Fusion\Bus\Events\Config as ConfigEvent;
use Valvoid\Fusion\Log\Events\Level;
use Valvoid\Fusion\Tasks\Snap\Snap;
use Valvoid\Fusion\Tasks\Snap\Config\Interpreter;
...
class InterpreterTest extends Test
{
    ...
    public function testDefault(): void
    {
        ...
        Bus::addReceiver(self::class, $this->handleBusEvent(...), ConfigEvent::class);
        Interpreter::interpret([], Snap::class); // default string task config
