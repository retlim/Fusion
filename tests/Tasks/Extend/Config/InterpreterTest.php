...
namespace Valvoid\Fusion\Tests\Tasks\Extend\Config;
...
use Valvoid\Fusion\Tasks\Extend\Config\Interpreter;
...
class InterpreterTest extends Test
{
    ...
    public function testDefault(): void
    {
        ...
        Bus::addReceiver(self::class, $this->handleBusEvent(...), ConfigEvent::class);
        Interpreter::interpret([], Extend::class); // default string task config
