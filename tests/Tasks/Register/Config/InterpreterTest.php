...
namespace Valvoid\Fusion\Tests\Tasks\Register\Config;
...
use Valvoid\Fusion\Tasks\Register\Config\Interpreter;
...
class InterpreterTest extends Test
{
    ...
    public function testDefault(): void
    {
        ...
        Bus::addReceiver(self::class, $this->handleBusEvent(...), ConfigEvent::class);
        Interpreter::interpret([], Register::class); // default string task config
