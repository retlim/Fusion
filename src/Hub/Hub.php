...
class Hub
{
    ...
    public static function addVersionsRequest(array $source): int
    {
        ...
        return self::$instance->addVersionsRequest_($source);
    }
     ...
     * @throws RequestError Request exception.
     */
    protected function addVersionsRequest_(array $source): int
    {
    ...
    public static function addMetadataRequest(array $source): int
    {
        // decoupled logic
        // trailing underscore identifier
        return self::$instance->addMetadataRequest_($source);
    }
     ...
     * @throws HubError Hub exception.
     */
    protected function addMetadataRequest_(array $source): int
    {
    ...
    public static function addSnapshotRequest(array $source, string $path): int
    {
        // decoupled logic
        // trailing underscore identifier
        return self::$instance->addSnapshotRequest_($source, $path);
    }
     ...
     * @throws HubError Hub exception.
     */
    protected function addSnapshotRequest_(array $source, string $path): int
    {
        return $this->addFileRequest($source,
    ...
    public static function addArchiveRequest(array $source): int
    {
        // decoupled logic
        // trailing underscore identifier
        return self::$instance->addArchiveRequest_($source);
    }
    ...
    public static function executeRequests(Closure $callback): void
    {
        // decoupled logic
        // trailing underscore identifier
        self::$instance->executeRequests_($callback);
    }
